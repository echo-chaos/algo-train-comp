 ...
 * @date: 2024-06-02 21:22
 * @description: 55. 跳跃游戏 <a href="https://leetcode.cn/problems/jump-game/description/?envType=study-plan-v2&envId=top-100-liked">...</a>
 **/
    ...
    public boolean canJump(int[] nums) {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            if (i <= rightMost) {
                ...
                // 如果最远边界已经超过或等于数组最后一个下标，说明可以到达最后
                if (rightMost >= n - 1) {
                    return true;
                }
            }
